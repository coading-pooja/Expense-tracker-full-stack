...
const authenticate = (req,res,next) =>{
    ...
    try{
        ...
        const decodedToken = jwt.verify(token, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjIsIm5hbWUiOiJ2cml0dGkiLCJpYXQiOjE2OTU3MjQ1MjJ9.rd0kbNwNs6CBecUx20vDSfKMSA0rVYK8nPxhY3Mu-kc"); //decrpting the secret key
